...
!(function(window, document, undefined) {
  ...
  isSVG ||
    !(function(A, e) {
      ...
      function a(A, t) {
        ...
        t = t || o(A);
        for (
          var r = t.frag.cloneNode(), i = 0, a = n(), d = a.length;
          d > i;
          i++
        )
          r.createElement(a[i]);
    ...
    Modernizr.addAsyncTest(function() {
      ...
      if (
        ...
        if (
          ...
          return t(s), r("blocked", d), void n(s);
        (i = function() {
          return (
            t(s),
            docElement.contains(s)
              ? (docElement.contains(d)
                  ? ((a = d.style.cssText),
                    "" !== a ? r("blocked", d) : r(!0, d))
                  : r("blocked"),
                void n(s))
  ...
  blacklist
    ...
    Modernizr.addTest("hairline", function() {
      return testStyles("#modernizr {border:.5px solid transparent}", function(
        A
      ) {
  ...
  Modernizr.addTest("xhrresponsetypearraybuffer", testXhrType("arraybuffer")),
    ...
    testStyles(
      ...
      function(A) {
        ...
        Modernizr.addTest(
          "cssvmaxunit",
          roundedEquals(a, d) || roundedEquals(a, d - r)
        );
      },
      3
    ),
      ...
      function A() {
        ...
        function r(A) {
          try {
            ...
            return (
              document.body.removeChild(n), document.body.removeChild(t), o
            );
          } catch (a) {
            return !1;
          }
